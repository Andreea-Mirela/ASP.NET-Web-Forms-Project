...
namespace Proiect
{
    public partial class StaticticiBrokeriForm : System.Web.UI.Page
    {
        ...
        private void OnRenderGraph(ZedGraph.Web.ZedGraphWeb z, System.Drawing.Graphics g, ZedGraph.MasterPane masterPane)
        {
            ...
            DataSet ds = (DataSet)Cache["InvestCache"];
            GraphPane myPane = masterPane[0];
            myPane.Title.Text = "";
            myPane.XAxis.Title.Text = "Brokeri"; myPane.YAxis.Title.Text = "Experienta";
            Color[] colors = {
            ...
            if (Request.QueryString["tip"] != null)
            {
                ...
                {
                    listaX.Add(r[1].ToString()); // nume broker
                    list.Add(0, (double)r[3], i++); // ani experienta
                }
                    ...
                    case "Pie":
                        {
                            ...
                            foreach (DataRow r in ds.Tables[0].Rows)
                            {
                                PieItem segment1 = myPane.AddPieSlice((double)r[3], colors[(i++) % colors.Length], Color.White, 45f, (i % 2 == 0) ? 0.2 : 0, r[1].ToString());
                            }
                            break;
                        }
                }
